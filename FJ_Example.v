...
by (unfold pair_flds; eauto using binds_first, binds_other).
assert (typing ((this, Pair) :: setfst_env) (e_var newfst) Object)
by (unfold setfst_env; eauto using binds_first, binds_other).
assert (wide_typings ((this, Pair) :: setfst_env) ((e_var newfst)::(e_field (e_var this) snd)::nil) (imgs pair_flds))
by (unfold pair_flds; simpl; eauto 10 using binds_first).
...
by (unfold ok_meth'; apply ex_ok_setfst).
auto.
Qed.
